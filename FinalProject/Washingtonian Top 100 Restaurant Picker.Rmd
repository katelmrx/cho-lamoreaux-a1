...
washington_yelp_combine <- washington_yelp[, c("ranking", "name.x", "genre", "address.x", "rating", "price")]
head(washington_yelp_combine)

colnames <- c("washingtonion ranking", "name", "genre", "address", "yelp rating", "price")
names(washington_yelp_combine) <- colnames
head(washington_yelp_combine)
```

```{r}
# exportlist <- write.xlsx(washington_yelp_combine, "/Users/sungjoocho/Desktop/UMD/Fall2023/SURV727/Group_assignment/cho-lamoreaux-a1/washington_yelp_combine.xlsx")
```
